...
namespace Komorebi.Debug
{
    public class CharacterDebugInfo
    {
        ...
        private void RegisterDebugInfo()
        {
            ...
            var inputCategory = debugManager.CreateCategory("Input");
            ...
            var movementCategory = debugManager.CreateCategory("Movement");
            ...
            var velocityCategory = debugManager.CreateCategory("Velocity");
            velocityCategory.AddDebugValue("Current", () => FormatVector3(_rigidbody.linearVelocity));

            var brakeCategory = debugManager.CreateCategory("Brake Forces");
            ...
            var interactCategory = debugManager.CreateCategory("Interact");
